...
Let's not forget that we did not take into account all the social factors. Indeed, we cannot say that having more arrestations of African Americans implies that they are discriminated. As for the observed change, we can make several hypotheses !
If we assume that the differences observed in the number of arrestations between Black and White poeple are due to the discrimination against African Americans, we can state that the above mentioned changes are due to a decrease in these discriminations. This change could be due and influenced by the creation of the Black Lives Matter movement. Other hypotheses could explain this such as a possible change in citizens' mentalities tending to decrease racial bias. Let's not forget the election of Mayor Garcetti, that happened exactly at the same time as the creation of the movement, that could also have an impact.
</p>
___
